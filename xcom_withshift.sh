...
echo "imcombine(\"@newcomlistwithshift\",\"$comimage\", reject=\"avsigclip\",combine=\"median\",scale=\"exposure\",weight=\"exposure\",rdnoise=$rdnoise,gain=$gain)" >>login.cl
...
xmakeTemp ( )
{
    ...
    ls xmatchdaofind.sex
	 sex $firstimage  -c  xmatchdaofind.sex -DETECT_THRESH 25 -ANALYSIS_THRESH 25 -CATALOG_NAME image.sex -CHECKIMAGE_TYPE BACKGROUND -CHECKIMAGE_NAME  $bgimage
	rm -rf $bgimage
