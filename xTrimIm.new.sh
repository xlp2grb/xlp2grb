...
wait
#ds9 -fits $imsubname  -scale limits  -100 200  -zoom to fit -saveimage png $imsubnamePNG &  
...
wait
#ds9 -fits $refsubname  -scale limits  -100 200  -zoom to fit -saveimage png $refsubnamePNG & 
#============================
