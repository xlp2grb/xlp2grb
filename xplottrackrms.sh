...
plot [][0:0.2] 'allxyrms.cat.plot' u 1:2 w lp pt 6 ps 2 title 'xrms','allxyrms.cat.plot' u 1:3 w lp pt 8 ps 2 title 'yrms','allxyrmsfalse.cat.plot' u 1:2 w p pt 6 ps 2 title 'X false', 'allxyrmsfalse.cat.plot' u 1:3 w p pt 8 ps 2 title 'Y false'
reset
quit
EOF
else
...
set output "$rmspngfile"
set ylabel "X/Y RMS for xyxymatch"
plot [][0:0.2] 'allxyrms.cat.plot' u 1:2 w lp pt 6 ps 2 title 'xrms','allxyrms.cat.plot' u 1:3 w lp pt 8 ps 2 title 'yrms'
reset
quit
EOF
fi
